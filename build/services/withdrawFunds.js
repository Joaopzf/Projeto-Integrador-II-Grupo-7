...
exports.withdrawFundsWithTax = void 0;
const mysql_1 = __importDefault(require("../db/mysql"));
const withdrawFundsWithTax = async (userId, amount, bankDetails) => {
    try {
        ...
        await mysql_1.default.execute("UPDATE wallets SET bank_name = ?, agency_number = ?, account_number = ?, pix_key = ? WHERE user_id = ?", [
        ...
        await mysql_1.default.execute("INSERT INTO transactions (user_id, amount, transaction_type) VALUES (?, ?, ?)", [userId, amount, "retirada"]);
...
exports.withdrawFundsWithTax = withdrawFundsWithTax;
